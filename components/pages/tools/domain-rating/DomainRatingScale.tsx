import { DR_BANDS } from "@/components/pages/tools/domain-rating/bands";
    ...
    <section className="border-b">
      <div className="border-b px-6 py-10 md:px-12 md:py-14">
        ...
        <p className="mt-3 max-w-xl text-lg text-zinc-500 text-balance">
          Domain Rating is 0 to 100. It estimates how strong a site’s
          backlinks are — not how much traffic it gets.
        </p>
      </div>
