...
export const winnDixieCaseStudy: CaseStudy = {
  slug: "winn-dixie",
  company: "Winn-Dixie",
  ...
  results: {
    heading: "The results: from invisible to industry-leading",
    intro: [
      "The impact was transformative across visibility, market share of mentions, traffic quality, and conversion.",
    ],
    metrics: [
      {
        value: "5×",
        ...
        detail:
          "Winn-Dixie's visibility score in ChatGPT increased 500% over the pilot, with consistent month-over-month growth",
        figure: {
      ...
      },
      {
        ...
        detail:
          "Share of grocery-store mentions in AI answers rose 32%, taking share from competitors like Publix and Kroger",
        figure: {
          src: "/case-studies/winn-dixie/share-of-voice.jpg",
          alt: "Pie charts comparing Winn-Dixie ChatGPT share of voice pre-pilot versus today against Kroger, Publix, Sedanos, and Walmart",
          caption:
            "Share of voice in ChatGPT increased +32% versus grocery competitors",
          width: 1024,
          height: 662,
        },
      },
      {
        ...
        detail:
          "ChatGPT went from minimal traffic to driving more organic visits than Instagram, Facebook, and Yelp combined",
        figure: {
          src: "/case-studies/winn-dixie/traffic-acquisition.jpg",
          alt: "GA4 traffic acquisition chart showing chatgpt.com sessions overtaking Instagram, Facebook, and Yelp",
          caption:
            "chatgpt.com became a top organic acquisition source versus Instagram, Facebook, and Yelp",
          width: 1024,
          height: 359,
        },
      },
      {
        ...
        detail:
          "Visitors from AI platforms showed purchase intent five times higher than traditional search traffic",
      },
    ],
  },
  closing: {
