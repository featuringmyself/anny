...
const services = [
  ...
  },
  {
    ...
    body: "Empower your in-house team with customized training on Generative Engine Optimization (GEO) and how to leverage the Dodox platform.",
      ...
      <div className="mx-auto flex w-full max-w-260 flex-col items-center gap-12 px-6 lg:gap-14 xl:gap-16">
        <div className="mx-auto flex w-full max-w-150 flex-col items-center text-center lg:max-w-187.5">
          ...
          <p
            ...
            style={{ color: BODY }}
          >
            Dodox team provides the winning strategy. We partner with you to
