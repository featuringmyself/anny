...
export const TracingBeam = ({
  ...
  return (
    ...
    >
      <div className="absolute top-3 -left-4 hidden md:-left-12 md:block lg:-left-16 xl:-left-20">
        <motion.div
          transition={{
            duration: 0.2,
            delay: 0.5,
        ...
        >
          <motion.div
            ...
            animate={{
              backgroundColor: scrolled ? "white" : "#2462ff",
              borderColor: scrolled ? "white" : "#1d4ed8",
            }}
        ...
        >
          ...
          <defs>
            ...
            >
              ...
              <stop offset="0.325" stopColor="#2462ff" />
